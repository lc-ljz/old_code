...
#                     default='../datasets/blurred_sharp/blurred_sharp/blurred')
# parser.add_argument('--fold_B', dest='fold_B', help='input directory for image B', type=str,
#                     default='../datasets/blurred_sharp/blurred_sharp/sharp')
# parser.add_argument('--fold_AB', dest='fold_AB', help='output directory', type=str,
#                     default='../datasets/blurred_sharp/blurred_sharp/test_AB')
