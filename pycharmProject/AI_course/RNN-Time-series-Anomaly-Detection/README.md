...
## Requirements
* Ubuntu 16.04+ (Errors reported on Windows 10. see [issue](https://github.com/chickenbestlover/RNN-Time-series-Anomaly-Detection/issues/6#issue-358550020). 
...
## Dataset
__ 1. NYC taxi passenger count__
...
__ 1. How to train this model__
...
__ 1. Time-series prediction:__
...
__ 1. Precision, recall, and F1 score:__
