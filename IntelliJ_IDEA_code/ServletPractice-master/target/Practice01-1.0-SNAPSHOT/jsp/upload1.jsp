...
<head lang="en">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/jsp/js/upload1.js" charset="UTF-8"></script>
...
<div class="easyui-layout" id="MainLayout" data-options="fit:true,border:false" >
    <div id="OrganizationTreePanel" data-options="region:'west',collapsed:false,split:true,title:'目录信息'" style="width:13%;height: 85%">
...
<%--            </div>--%>
            <div data-options="region:'center',border:true,fit:true"  id="DataCenterPanel">
                <div class="easyui-layout" data-options="fit:true,border:true"  id="DataShowLayout">
                    <div id="DetailArea"  data-options="region:'north',split:true" style="height:70%;">
...
<%--                             url:'../GetTaskListController',method:'get',fitColumns:true">--%>
                            method:'get',fitColumns:true,pageSize : 10,pageList : [10,15]">
                        </table>

                    </div>
                    <div id="gaiInfo" data-options="region:'center',border:true,title:'备注信息',split:true"style="height:30%" >
                        <textarea name="Remark" id="Remark" style="height: 90%;width: 100%" readonly style="font-size:15px"></textarea>
                    </div>
                </div>
            </div>
        </div>
...
<div id="orderAddWindow" class="easyui-dialog" title="添加任务" data-options="modal:true,closed:true,resizable:true,
	iconCls:'icon-save',buttons:'#addDialog-buttons'" style="width:750px;height:450px;">
    <div>
...
<%--                    <input id="txtTypeCbo" name="txtTypeCbo" class="easyui-combobox"  />--%>
                    <select id="txtTypeCbo" name="txtTypeCbo" class="easyui-combobox">
                                                <option value="岗位应知应会" selected="selected">岗位应知应会</option>
                                                <option value="部门安全管理体系">部门安全管理体系</option>
                                                <option value="部门环保管理体系">部门环保管理体系</option>
            ...
            <tr>
                <td>文件目录:</td>
                <td>
                    <input id="postFolder" name="postName" class="easyui-combobox"  />
                </td>
            </tr>
