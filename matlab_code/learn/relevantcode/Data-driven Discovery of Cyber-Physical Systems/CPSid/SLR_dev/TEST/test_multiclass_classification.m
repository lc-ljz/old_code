...
%--------------------------------
tic
fprintf('\nOne-versus-rest old(ARD-Varitional)!!\n')
[ww_o, ix_eff_o, errTable_tr_o, errTable_te_o] = muclsfy_slrvarovrm(xtr, ttr, xte, tte,...
     'nlearn', 300, 'mean_mode', 'none', 'scale_mode', 'none');
toc

tic
fprintf('\nOne-versus-One new (ARD-Variational)!!\n')
[ww_f, ix_eff_f, errTable_tr_f, errTable_te_f] = muclsfy_slrvarovo2(xtr, ttr, xte, tte,...
    'nlearn', 300, 'mean_mode', 'none', 'scale_mode', 'none');
toc

tic
fprintf('\n\nSMLR (ARD-Laplace)!!\n')
    [ww_s, ix_eff_s, errTable_tr_s, errTable_te_s, g_s] =muclsfy_smlr(xtr, ttr, xte, tte, ...
