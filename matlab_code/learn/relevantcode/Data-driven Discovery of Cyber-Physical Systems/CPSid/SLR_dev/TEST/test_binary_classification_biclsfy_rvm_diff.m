...
fprintf('\n\nLinear RVM (ARD-Variational)!!\n')
    [ww_rvm, ix_eff_rvm, errTable_tr_rvm, errTable_te_rvm, g_rvm, ax_rvm, ptr, pte] = run_rvm(xtr, ttr, xte, tte, 0, ...
        'nlearn', 1000, 'nstep', 1000, 'mean_mode', 'none', 'scale_mode', 'none', 'amax', 1e8);
toc

tic
fprintf('\n\nLinear RVM (ARD-Variational)!!\n')
    [ww_rvmn, ix_eff_rvmn, errTable_tr_rvmn, errTable_te_rvmn, g_rvmn, ax_rvmn, ptrn, pten] = biclsfy_rvm(xtr, ttr, xte, tte, 0, ...
        'nlearn', 1000, 'nstep', 1000, 'mean_mode', 'none', 'scale_mode', 'none', 'amax', 1e8);
toc

ww_rvm - ww_rvmn
ix_eff_rvm - ix_eff_rvmn 
errTable_tr_rvm - errTable_tr_rvmn
errTable_te_rvm - errTable_te_rvmn
ax_rvm - ax_rvmn
ptr - ptrn
pte - pten
