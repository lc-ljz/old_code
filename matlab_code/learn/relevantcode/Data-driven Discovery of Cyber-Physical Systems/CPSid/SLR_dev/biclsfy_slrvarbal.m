function [ww, ix_eff_all, errTable_tr, errTable_te, parm, AXall,Ptr,Pte,t_train_est,t_test_est] =...
    biclsfy_slrvarbal(x_train, t_train, x_test, t_test, varargin)
% Binary classification by SLR with variational parameters approximation (SLR-VAR).
% Compensating unbalanced samples by the weighted likelihood method. 
%
% -- Usage
...
% 2015/06/29 OY
% * support balanced-correction learning for unbalanced sample case  
% 2013/11/01 OY
...
[ww, ix_eff, W, AXall] = slr_learning_var_bal(b_train, Xtr,...
    'nlearn', Nlearn, 'nstep', Nstep, 'amax', AMAX, 'invhessian', invhessian, 'balanced', balanced);
